...
var _ = require('lodash'),
  defaultAssets = require('./app/config/assets/default'),
  testAssets = require('./app/config/assets/test'),
  testConfig = require('./app/config/env/test'),
  fs = require('fs'),
  path = require('path');
...
module.exports = function (grunt) {
  ...
  grunt.registerTask('test', ['env:test', 'lint', 'server', 'mochaTest', 'karma:unit', 'protractor']);
